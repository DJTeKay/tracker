...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			<form action="index.php?page=new_course" method="post" id="manage-project">
...
if(isset($_POST['save'])){
    ...
    {     
        ...
        $sql="INSERT INTO `course_list` (`name`, `manager`, `student`, `date`, `time`, `faculty`)
        VALUES ('$name','$manager','".$student."','$start_date','$end_date','$faculty')";    
        ...
        if (mysqli_query($conn, $sql)) {
                ...
                echo "<script>";
                echo "alert('Course not created')";
                echo "</script>";
        }

        //add to work load list	
			
		$sql="UPDATE `workload` SET  `projects` = (`projects` + 0), `students` = (`students` + 1),
        `available` = ( `available` - 1)  where `email` = $manager ";
